...
async def googleurl(request: Request) -> ORJSONResponse:
    ...
    google_login_url = 'https://foodsharehub.auth.ap-southeast-1.amazoncognito.com/oauth2/authorize?identity_provider=Google&redirect_uri=http://foodsharehub-alb-1873055449.ap-southeast-1.elb.amazonaws.com/login&response_type=TOKEN&client_id=7uq1jl7tbrcg525aeddpg0hhev&scope=email openid profile'
